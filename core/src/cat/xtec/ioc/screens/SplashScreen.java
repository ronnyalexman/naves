...
public class SplashScreen implements Screen {
    ...
    public SplashScreen(SpaceRace game) {
        ...
        containerStart.setPosition(Settings.GAME_WIDTH / 2, (Settings.GAME_HEIGHT / 6)*5);
        ...
        containerStart.addAction(Actions.repeat(RepeatAction.FOREVER, Actions.sequence(Actions.run(new Runnable() {
            ...
            public void run() {
                Actions.delay(1f);
                containerStart.setVisible(true);
                Actions.delay(1f);
                containerStart.setVisible(false);
            }
